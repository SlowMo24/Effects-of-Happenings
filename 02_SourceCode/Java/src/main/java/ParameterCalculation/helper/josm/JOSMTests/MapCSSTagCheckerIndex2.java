...
import ParameterCalculation.helper.josm.JOSMTests.EnhancedMapCSSTagChecker.TagCheck;
 ...
 *
 */
final class MapCSSTagCheckerIndex2 {
    ...
    MapCSSTagCheckerIndex2(MultiMap<String, TagCheck> checks, boolean includeOtherSeverity, boolean allTests) {
