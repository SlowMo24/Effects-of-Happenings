 ...
 * @since 5644
 */
public class EnhancedAddresses extends Test {
    ...
    protected List<Relation> getAndCheckAssociatedStreets(OsmPrimitive p) {
        final List<Relation> list = new ArrayList<>();
    ...
    public boolean isFixable(TestError testError) {
        if (!(testError.getTester() instanceof EnhancedAddresses))
            return false;
